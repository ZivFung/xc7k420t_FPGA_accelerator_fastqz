...
#
# RecreateProject.tcl: Tcl script for re-creating project 'fastqz_fxa_0'
#
# Generated by Vivado on Thu Dec 12 23:21:41 CST 2019
...
#
#    "/run/media/romeo/Linux/Project/UGD/fastqz_fxa_mulchannel/fastqz_fxa_0.srcs/sources_1/new/reset_185u.v"
#    "/run/media/romeo/Linux/Project/UGD/fastqz_fxa_mulchannel/fastqz_fxa_0.srcs/sources_1/bd/fastqz_fxa/fastqz_fxa.bd"
#    "/run/media/romeo/Linux/Project/UGD/fastqz_fxa_mulchannel/fastqz_fxa_0.srcs/sources_1/bd/fastqz_fxa/hdl/fastqz_fxa_wrapper.v"
#    "/run/media/romeo/Linux/Project/UGD/fastqz_fxa_mulchannel/fastqz_fxa_0.srcs/sources_1/bd/fastqz_fxa/ip/fastqz_fxa_mig_7series_0_0/mig_a.prj"
#    "/run/media/romeo/Linux/Project/UGD/fastqz_fxa_mulchannel/fastqz_fxa_0.srcs/sources_1/bd/fastqz_fxa/ip/fastqz_fxa_mig_7series_0_1/mig_a.prj"
#    "/run/media/romeo/Linux/Project/UGD/fastqz_fxa_mulchannel/fastqz_fxa_0.srcs/sources_1/bd/fastqz_fxa/ip/fastqz_fxa_mig_7series_0_1/mig_b.prj"
#    "/run/media/romeo/Linux/Project/UGD/fastqz_fxa_mulchannel/fastqz_fxa_0.srcs/constrs_1/new/pins.xdc"
#    "/run/media/romeo/Linux/Project/UGD/fastqz_fxa_mulchannel/fastqz_fxa_0.srcs/constrs_1/new/timing.xdc"
#    "/run/media/romeo/Linux/Project/UGD/fastqz_fxa_mulchannel/fastqz_fxa_0.srcs/constrs_1/new/bitstream.xdc"
#
...
set _xil_proj_name_ "fastqz_fxa_0"
...
# Create project
create_project ${_xil_proj_name_} ./${_xil_proj_name_} -part xc7k420tiffg901-2L
...
set_property -name "part" -value "xc7k420tiffg901-2L" -objects $obj
...
set files [list \
 [file normalize "${origin_dir}/fastqz_fxa_0.srcs/sources_1/new/reset_185u.v" ]\
 [file normalize "${origin_dir}/fastqz_fxa_0.srcs/sources_1/bd/fastqz_fxa/fastqz_fxa.bd" ]\
 [file normalize "${origin_dir}/fastqz_fxa_0.srcs/sources_1/bd/fastqz_fxa/hdl/fastqz_fxa_wrapper.v" ]\
 [file normalize "${origin_dir}/fastqz_fxa_0.srcs/sources_1/bd/fastqz_fxa/ip/fastqz_fxa_mig_7series_0_0/mig_a.prj" ]\
 [file normalize "${origin_dir}/fastqz_fxa_0.srcs/sources_1/bd/fastqz_fxa/ip/fastqz_fxa_mig_7series_0_1/mig_a.prj" ]\
 [file normalize "${origin_dir}/fastqz_fxa_0.srcs/sources_1/bd/fastqz_fxa/ip/fastqz_fxa_mig_7series_0_1/mig_b.prj" ]\
]
...
set file "fastqz_fxa/fastqz_fxa.bd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set file "hdl/fastqz_fxa_wrapper.v"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set file "fastqz_fxa_mig_7series_0_0/mig_a.prj"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
set_property -name "library" -value "xil_defaultlib" -objects $file_obj
set_property -name "path_mode" -value "RelativeFirst" -objects $file_obj
set_property -name "scoped_to_cells" -value "fastqz_fxa_mig_7series_0_0" -objects $file_obj
set_property -name "scoped_to_ref" -value "" -objects $file_obj
set_property -name "used_in" -value "synthesis" -objects $file_obj
set_property -name "used_in_synthesis" -value "1" -objects $file_obj

set file "fastqz_fxa_mig_7series_0_1/mig_a.prj"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
set_property -name "library" -value "xil_defaultlib" -objects $file_obj
set_property -name "path_mode" -value "RelativeFirst" -objects $file_obj
set_property -name "scoped_to_cells" -value "fastqz_fxa_mig_7series_0_1" -objects $file_obj
set_property -name "scoped_to_ref" -value "" -objects $file_obj
set_property -name "used_in" -value "synthesis" -objects $file_obj
set_property -name "used_in_synthesis" -value "1" -objects $file_obj

set file "fastqz_fxa_mig_7series_0_1/mig_b.prj"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
set_property -name "library" -value "xil_defaultlib" -objects $file_obj
...
set_property -name "top" -value "fastqz_fxa_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/fastqz_fxa_0.srcs/constrs_1/new/pins.xdc"]"
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/fastqz_fxa_0.srcs/constrs_1/new/timing.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/fastqz_fxa_0.srcs/constrs_1/new/bitstream.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "new/bitstream.xdc"
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
set_property -name "target_constrs_file" -value "[get_files *new/timing.xdc]" -objects $obj
set_property -name "target_part" -value "xc7k420tiffg901-2L" -objects $obj
set_property -name "target_ucf" -value "[get_files *new/timing.xdc]" -objects $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7k420tiffg901-2L -flow {Vivado Synthesis 2018} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7k420tiffg901-2L -flow {Vivado Implementation 2018} -strategy "Performance_Explore" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
